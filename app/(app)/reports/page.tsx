...
export default async function ReportsPage() {
  ...
  if (savingsError) console.error('Reports savings error:', savingsError)
  if (invError) console.error('Reports investments error:', invError)
  if (subsError) console.error('Reports subscriptions error:', subsError)
